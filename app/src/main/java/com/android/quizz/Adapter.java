...
public class Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Categories categories = DataStorage.listViewData.get(position);
        Log.d("Scroll", String.valueOf(position));
        ime.setText(categories.getIme());
        imageTmb.setImageResource(categories.getTmbImageId(mContext));
